...
import com.example.findmypet.Activities.PrivateChat.PrivateChatActivity;
...
public class ChatsAdapter extends RecyclerView.Adapter<ChatsAdapter.ViewHolder> implements Filterable {
    ...
    public ChatsAdapter(List<ChatModel> chatsModelList, Activity activity) {
...
//                    .getPhoto()).into(holder.image_noti);
        ...
        holder.constraint_chat.setOnClickListener(view1 -> {
            Intent intent = new Intent(activity, PrivateChatActivity.class);
            intent.putExtra("otherUser", chatsModelList.get(position).getId());
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder{
        ...
        private final ConstraintLayout constraint_chat;
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            constraint_chat = itemView.findViewById(R.id.constraint_chat);
        }
    }
